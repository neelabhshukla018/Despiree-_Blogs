...
const Dashboard = () => {
  ...
  const fetchBlogs = async () => {
    ...
    try {
      ...
      toast.error(
        "Unable to load your blogs. Please try again."
      );
  ...
  const deleteBlog = async (id) => {
    ...
    try {
      ...
      toast.error(
        "Unable to delete the blog. Please try again."
      );
